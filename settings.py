...
timeout    = 20               # Number of seconds to wait before raising an error
...
usepos     = False            # Activate only, if you are sure that ALL as avaiable marked artices are available at all points of sale.
